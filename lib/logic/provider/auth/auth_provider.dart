...
import 'package:kraftbase_chat_app/data/extension/string_extension.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

import '../../../data/models/signup/signupModel.dart';
...
class AuthProvider with ChangeNotifier {
  ...
  void onSignOut(
      {required Function() success, required Function() failure}) async {
    try {
       await repo.onSignOut();
      
      notifyListeners();
      success();
      notifyListeners();
    } catch (err) {
      debugPrint('signouy error :$err');
      failure();
    }
  }
}
